...
namespace TrafficGenerator
{
	public class SlowToStop_InPlace : SlowToStop
	{
		...
		public SlowToStop_InPlace(Car[] initialRoadState, uint roadLength, uint maxVelocity, double faultProbability, double slowProbability, IGenerator randomNumberGenerator) : base(initialRoadState, roadLength, maxVelocity, faultProbability, slowProbability, randomNumberGenerator) { }
